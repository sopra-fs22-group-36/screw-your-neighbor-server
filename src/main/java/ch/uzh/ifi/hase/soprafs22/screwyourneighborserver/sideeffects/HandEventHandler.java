...
public class HandEventHandler {
    ...
    public void onAfterSave(Hand hand) {
        ...
        Match myMatch = matchRepository.findById(idMatch).orElseThrow(() -> new EntityNotFoundException(idMatch + ""));
